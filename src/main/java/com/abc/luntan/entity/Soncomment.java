...
public class Soncomment implements Serializable {
     ...
     * 评论的父级评论id，默认为null
     */
    private Long sonCommentParentId;
    ...
    public Soncomment(Long sonCommentParentId, String sonCommentUserId, String sonCommentReplyUserId, String sonCommentContent, Date sonCommentCreatedTime) {
    ...
    public Soncomment(Integer sonCommentId, Long sonCommentParentId, String sonCommentUserId, String sonCommentReplyUserId, String sonCommentContent, Integer sonCommentLikeCount, Date sonCommentCreatedTime, boolean isLiked, String commentUserName, String commentUserAvatar, String commentReplyName, String commentReplyAvatar) {
    ...
    public Soncomment(Integer sonCommentParentId, String email, String sonCommentReplyId, String sonCommentContent, DateTime date) {
    }
     ...
     * 评论的父级评论id，默认为null
     */
    public Long getSonCommentParentId() {
     ...
     * 评论的父级评论id，默认为null
     */
    public void setSonCommentParentId(Long sonCommentParentId) {
        this.sonCommentParentId = sonCommentParentId;
    }
