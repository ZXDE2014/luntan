...
public class Firstcomment implements Serializable {
    public Firstcomment(Long firstCommentId, Integer firstCommentArticleId, String firstCommentUserId, String firstCommentContent, Integer firstCommentLikeCount, Integer firstCommentCount, Date firstCommentCreatedTime) {
